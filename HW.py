...
for t in range(T, 0, -1):
    ...
    for I in range(len(S[t])):
        ...
        for i in range(len(S[t][I])): # 找出該組合最大值
            if len(S[t][I][i]):
                if S[t][I][i]['整體滿意度'] >= MaxS['整體滿意度'] and t != T and sorted(S[t][I][i]['餐點'].split(',')) != sorted(MaxS['餐點'].split(',')): # 複數最佳解
...
# print(Opt)            
{2: {0: {'餐點': '叻沙牛肉麵', '整體滿意度': 90, '價格': 160, '熱量': 945}, 1: {'餐點': '333', '整體滿意度': 79, '價格': 140, '熱量': 875}, 2: {'餐點': '222', '整體滿意度': 79, '價格': 140, '熱量': 875}, 3: {'餐點': '石鍋拌飯', '整體滿意度': 79, '價格': 140, '熱量': 875}, 4: {'餐點': '花生雞腿堡', '整體滿意度': 70, '價格': 129, '熱量': 716}}, 
1: {0: {'餐點': '叻沙牛肉麵,333', '整體滿意度': 169, '價格': 300, '熱量': 1820}, 1: {'餐點': '叻沙牛肉麵,333', '整體滿意度': 169, '價格': 300, '熱量': 1820}, 2: {'餐點': '叻沙牛肉麵,222', '整體滿意度': 169, '價格': 300, '熱量': 1820}, 3: {'餐點': '叻沙牛肉麵,石鍋拌飯', '整體滿意度': 169, '價格': 300, '熱量': 1820}, 4: {}, 5: {0: {'餐點': '叻沙牛肉麵,333', '整體滿意度': 169, '價格': 300, '熱量': 1820}}, 7: {0: {'餐點': '叻沙牛肉麵,222', '整體滿意度': 169, '價格': 300, '熱量': 1820}}, 9: {0: {'餐點': '叻沙牛肉麵,石鍋拌飯', '整體滿意度': 169, '價格': 300, '熱量': 1820}}}}